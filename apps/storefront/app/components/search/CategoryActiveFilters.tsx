/**
 * CategoryActiveFilters Component
 *
 * Displays currently active search filters as removable tags for category pages.
 * Uses the CategorySearchProvider context.
 *
 * @module app/components/search/CategoryActiveFilters
 */
...
/**
 * Props for the CategoryActiveFilters component
 */
 ...
 * CategoryActiveFilters Component
 */
const CategoryActiveFiltersComponent: FC<CategoryActiveFiltersProps> = ({
  filters,
  clearFilters,
  removeFilter,
  className,
...
/**
 * CategoryActiveFilters wrapped with Search UI context
 */
const CategoryActiveFiltersWithSearch = withSearch(({ filters, clearFilters, removeFilter }) => ({
  filters,
  clearFilters,
  removeFilter,
}))(CategoryActiveFiltersComponent) as FC<{ className?: string }>;

/**
 * SSR-safe CategoryActiveFilters component
 */
export const CategoryActiveFilters: FC<{ className?: string }> = ({ className }) => {
  ...
  return <CategoryActiveFiltersWithSearch className={className} />;
};

/**
 * Export the unwrapped component for testing purposes
 */
export { CategoryActiveFiltersComponent };
