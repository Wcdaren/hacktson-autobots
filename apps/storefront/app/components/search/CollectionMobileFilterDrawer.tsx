/**
 * CollectionMobileFilterDrawer Component
 *
 * A slide-in drawer component for mobile devices that displays collection filters.
 ...
 *
 * @module app/components/search/CollectionMobileFilterDrawer
 */
...
/**
 * Props for the CollectionMobileFilterDrawer component
 */
export interface CollectionMobileFilterDrawerProps {
  ...
  /** Whether to show metadata facets (default: true) */
 ...
 */
type CollectionMobileFilterDrawerInternalProps = CollectionMobileFilterDrawerProps & SearchContextProps;

/**
 * CollectionMobileFilterDrawer Internal Component
 */
const CollectionMobileFilterDrawerComponent: FC<CollectionMobileFilterDrawerInternalProps> = ({
  buttonClassName,
  drawerClassName,
  buttonLabel = 'Filters',
  showSort = true,
...
/**
 * CollectionMobileFilterDrawer wrapped with Search UI context
 */
const CollectionMobileFilterDrawerWithSearch = withSearch(({ filters }) => ({
  filters,
}))(CollectionMobileFilterDrawerComponent);

/**
 * SSR-safe CollectionMobileFilterDrawer component
 */
export const CollectionMobileFilterDrawer: FC<CollectionMobileFilterDrawerProps> = (props) => {
  ...
  return <CollectionMobileFilterDrawerWithSearch {...props} />;
};

/**
 * Export the unwrapped component for testing purposes
 */
export { CollectionMobileFilterDrawerComponent };
