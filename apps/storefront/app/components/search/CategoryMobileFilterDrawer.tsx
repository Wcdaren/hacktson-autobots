/**
 * CategoryMobileFilterDrawer Component
 *
 * A slide-in drawer component for mobile devices that displays category filters.
 ...
 *
 * @module app/components/search/CategoryMobileFilterDrawer
 */
...
/**
 * Props for the CategoryMobileFilterDrawer component
 */
export interface CategoryMobileFilterDrawerProps {
 ...
 */
type CategoryMobileFilterDrawerInternalProps = CategoryMobileFilterDrawerProps & SearchContextProps;

/**
 * CategoryMobileFilterDrawer Internal Component
 */
const CategoryMobileFilterDrawerComponent: FC<CategoryMobileFilterDrawerInternalProps> = ({
  buttonClassName,
  drawerClassName,
  buttonLabel = 'Filters',
  showSort = true,
...
/**
 * CategoryMobileFilterDrawer wrapped with Search UI context
 */
const CategoryMobileFilterDrawerWithSearch = withSearch(({ filters }) => ({
  filters,
}))(CategoryMobileFilterDrawerComponent);

/**
 * SSR-safe CategoryMobileFilterDrawer component
 */
export const CategoryMobileFilterDrawer: FC<CategoryMobileFilterDrawerProps> = (props) => {
  ...
  return <CategoryMobileFilterDrawerWithSearch {...props} />;
};

/**
 * Export the unwrapped component for testing purposes
 */
export { CategoryMobileFilterDrawerComponent };
