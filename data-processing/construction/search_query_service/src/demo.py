...
class MockSearchService:
    ...
    def search_text(self, query: str, max_results: int = 50) -> List[ProductMatch]:
...
def get_text_results(user_search_string: str) -> Dict:
    ...
    try:
        ...
        matches = search_service.search_text(user_search_string)
...
def main():
    ...
    # Test 4: No results
    print("Test 4: No results")
    print("-" * 80)
    query4 = "xyz123nonexistent"
    print(f"Query: '{query4}'")
    result4 = get_text_results(query4)
    print(json.dumps(result4, indent=2))
    print()
    
    # Test 5: Image search (mock)
    print("Test 5: Image search (mock)")
    print("-" * 80)
    print("Image: <base64_encoded_image>")
    result5 = get_image_match_result("mock_base64_data")
